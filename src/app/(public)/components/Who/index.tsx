      ...
      <div className="mx-auto max-w-4xl px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-flow-col-dense xl:grid-cols-2 xl:gap-x-8">
        <div className="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
          ...
          <p className="mt-5 text-lg text-gray-300">
            Somos uma equipe altamente capacitada e comprometida em atender às
            necessidades e exigências de nossos clientes, seguindo rigorosos
            padrões de desenvolvimento. Como empresa de consultoria SAP, lidamos
            com desafios desde os mais simples até os mais complexos, sempre
            visando construir parcerias duradouras. Oferecemos comprometimento,
            segurança, confiabilidade, disponibilidade e custos atrativos.
            Utilizamos métodos testados e aprimorados e mantemos nossos clientes
